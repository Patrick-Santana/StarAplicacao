package com.example.staraplicacao
...
/* context criado para ter acesso a uma activity para receber dados
da Api
 */
class ProposicoesAdapter (val list: List<Proposicao>, val context: Context, val requestQueue: RequestQueue): RecyclerView.Adapter<ProposicoesAdapter.ViewHolder>(){
    ...
    /*em kotlin quando a implementação  do método for pequeno, podemos trabalhar com atribuição
    xD
     */
    ...
    /* pegar os id's definidos em item_proposicao para serem exibidos na
    tela
     */
